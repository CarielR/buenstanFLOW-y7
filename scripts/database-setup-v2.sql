-- =====================================================
-- SISTEMA DE PRODUCCIÓN BUESTANFLOW - VERSION 2
-- Script de Base de Datos MySQL (ACTUALIZADO)
-- =====================================================
...
-- =====================================================
-- TABLA: pedido_insumos (NUEVA - Relación pedidos-insumos)
-- =====================================================
CREATE TABLE pedido_insumos (
    ...
    UNIQUE KEY unique_pedido_insumo (pedido_id, insumo_id),
    INDEX idx_pedido (pedido_id),
    INDEX idx_insumo (insumo_id)
);

-- =====================================================
-- TABLA: consumo_insumos (NUEVA - Registro de consumos)
-- =====================================================
...
-- =====================================================
-- TABLA: consumos_insumos (MANTENIDA PARA COMPATIBILIDAD)
-- =====================================================
...
('Cuero Base', 'Cuero básico para productos genéricos', 'm²', 100.000, 20.000, 30000.00, 'Curtiembre Local');
...
('P1028', 1, 1, 20, 'En cola', 'Media', 3000000.00, '2025-07-25', NULL);

-- Relaciones pedido-insumos para pedidos existentes
INSERT INTO pedido_insumos (pedido_id, insumo_id, cantidad_requerida) VALUES
-- P1023 - Zapato Clásico A (50 unidades)
('P1023', 1, 4.000), -- Cuero Premium
('P1023', 3, 50.000), -- Suela Goma
('P1023', 6, 50.000), -- Plantilla Estándar
('P1023', 8, 100.000), -- Cordones Clásicos

-- P1024 - Botín Casual B (30 unidades)
('P1024', 2, 3.000), -- Cuero Sintético
('P1024', 3, 30.000), -- Suela Goma
('P1024', 7, 30.000), -- Plantilla Comfort
('P1024', 14, 30.000), -- Forro Interno

-- P1025 - Sandalia Deportiva C (25 unidades)
('P1025', 2, 1.000), -- Cuero Sintético
('P1025', 4, 25.000), -- Suela Flexible
('P1025', 12, 50.000), -- Correa Ajustable
('P1025', 13, 25.000), -- Hebilla Metal

-- P1026 - Zapato Clásico A (40 unidades)
('P1026', 1, 3.200), -- Cuero Premium
('P1026', 3, 40.000), -- Suela Goma
('P1026', 6, 40.000), -- Plantilla Estándar
('P1026', 8, 80.000), -- Cordones Clásicos

-- P1027 - Botín Formal E (35 unidades)
('P1027', 1, 4.200), -- Cuero Premium
('P1027', 3, 35.000), -- Suela Goma
('P1027', 7, 35.000), -- Plantilla Comfort
('P1027', 15, 35.000), -- Forro Térmico
('P1027', 8, 70.000); -- Cordones Clásicos
...
('P1028', NULL, 'En cola', 1, 'Pedido creado');
...
CREATE INDEX idx_consumos_fecha_insumo ON consumo_insumos(fecha_consumo, insumo_id);
CREATE INDEX idx_movimientos_fecha_tipo ON movimientos_inventario(fecha_movimiento, tipo_movimiento);

-- =====================================================
-- SCRIPT COMPLETADO - VERSION 2
-- =====================================================
